...
def _sample_resources():
    """Return (influxd_cpu, influxd_rss_mb, telegraf_cpu, telegraf_rss_mb)."""
    return {
        "influxd_cpu":     proc_cpu_pct("/influxd")  or proc_cpu_pct("influxd "),
        "influxd_rss_mb":  (proc_rss_kb("/influxd")  or proc_rss_kb("influxd ")  or 0) / 1024,
        "telegraf_cpu":    proc_cpu_pct("/telegraf ") or proc_cpu_pct("telegraf "),
        "telegraf_rss_mb": (proc_rss_kb("/telegraf ") or proc_rss_kb("telegraf ") or 0) / 1024,
    }
